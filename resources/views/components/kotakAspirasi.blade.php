<div class="w-full flex justify-center px-4 py-10 bg-gray-50">
  <div class="w-full max-w-4xl">
    <div class=" rounded-2xl p-6 flex flex-col gap-6">
      ...
      <h2 class="text-2xl font-bold text-gray-800 text-center">Kotak Aspirasi</h2>
      ...
      <button 
        type="submit" 
        class="bg-blue-500 my-2 text-white font-semibold py-3 px-6 rounded-xl hover:bg-blue-600 transition-colors self-center"
      >
        Kirim
      </button>
    </form>
