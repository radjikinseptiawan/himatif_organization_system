    ...
    <div class="px-5 bg-[#416d9a] font-bold text-white w-full flex flex-row bottom-0 justify-between">
        <p>© <a href="{{ route("home") }}">HIMATIF-Univ.Pelita Bangsa</a></p>

        <p>Designed By Departemen LITBANG</p>
    </div>
