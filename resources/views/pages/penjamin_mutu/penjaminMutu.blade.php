...
<div class="flex items-center flex-col justify-center">
    <h1 class="text-3xl text-yellow-600 mt-35 font-bold">Penjamin Mutu</h1>
    <div class="p-1 flex items-center justify-center rounded-md my-3 bg-yellow-600 w-32"></div>
</div>

<div class="w-full mt-2 gap-4 flex flex-wrap items-center justify-center bg-gray-50 p-6">
